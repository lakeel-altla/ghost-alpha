...
public final class VirtualObjectManagementFragment extends Fragment {

    private static final Log LOG = LogFactory.getLog(VirtualObjectManagementFragment.class);
    ...
    public static VirtualObjectManagementFragment newInstance() {
        return new VirtualObjectManagementFragment();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getString(R.string.title_object_management));
