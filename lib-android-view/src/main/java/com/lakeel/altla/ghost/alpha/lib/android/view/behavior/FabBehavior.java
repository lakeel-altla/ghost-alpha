package com.lakeel.altla.ghost.alpha.lib.android.view.behavior;
...
public class FabBehavior extends FloatingActionButton.Behavior {
    ...
    private void animateShow(@NonNull FloatingActionButton child) {
        ViewCompat
                .animate(child)
                .scaleX(1.0F)
                .scaleY(1.0F)
    ...
    private void animateHide(@NonNull FloatingActionButton child) {
        ViewCompat
                .animate(child)
                .scaleX(0.0F)
                .scaleY(0.0F)
