...
public class RichLinkLoader {
    ...
    private RichLinkLoader() {
    }

    @NonNull
    public RichLink load(@NonNull String uriString) throws IOException {
    ...
    public static class Builder {
        ...
        //
        // Jsoup fails to load a html generated by Javascript.
        //
        ...
        @NonNull
        public RichLinkLoader build() {
            RichLinkLoader parser = new RichLinkLoader();
