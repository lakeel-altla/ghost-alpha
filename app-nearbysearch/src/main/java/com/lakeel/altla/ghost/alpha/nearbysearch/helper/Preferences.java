...
public final class Preferences {
    ...
    public static final String KEY_SORT_BY_BEARING_ORDER = "sort_by_bearing_order";
    ...
    public boolean isSortByBearingOrder() {
        return preferences.getBoolean(KEY_SORT_BY_BEARING_ORDER, false);
    }
